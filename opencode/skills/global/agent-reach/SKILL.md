...
name: agent-reach
description: >
  Use ONLY for platform-specific internet retrieval when the user asks about
  GitHub, Reddit, X/Twitter, YouTube, Bilibili, Xiaohongshu, LinkedIn,
  Facebook, Instagram, V2EX, or another platform supported by this skill.
  Use Wigolo instead for ordinary web research, documentation, URL fetching,
  and general internet search.

  MUST USE when user mentions a supported platform or shares a URL belonging
  to one:
  ...
  雪球/股票行情, RSS feeds, or a URL hosted on one of those platforms.
