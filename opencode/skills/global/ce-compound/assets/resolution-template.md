# Legacy Repository Resolution Templates

These templates belong to the retired repository-documentation mode of
`ce-compound`. The active skill writes personal contribution records to Basic
Memory and does not create `docs/solutions/` files. Do not use these templates
for the active personal-store workflow; they remain only as historical source
material.
