# Legacy Repository YAML Schema

This schema belongs to the retired repository-documentation mode of
`ce-compound`. The active skill uses Basic Memory metadata and does not write
`docs/solutions/` frontmatter. Do not use this file to create repository
documentation; retain it only as historical reference.
