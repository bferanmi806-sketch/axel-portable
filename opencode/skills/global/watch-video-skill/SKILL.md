---
name: watch-video
description: Use when the user wants Claude to watch, analyze, or take notes on a video, or explicitly types the literal `/watch-video` slash command. For ad-hoc YouTube questions without a clear "watch" intent, fetch the transcript directly (YouTube page or yt-dlp) and skim — do not run this heavyweight pipeline.
---
