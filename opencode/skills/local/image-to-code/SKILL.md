---
name: image-to-code
description: Use ONLY when a screenshot, visual reference, or image-first website workflow is available. Analyze the reference before implementing the frontend; do not use as a default for freeform coding.
---
