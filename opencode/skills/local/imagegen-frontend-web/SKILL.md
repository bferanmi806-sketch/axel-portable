...
description: Use ONLY when generating visual references or comps for websites, landing pages, marketing sites, or product pages. This skill generates images, not implementation code.
---
