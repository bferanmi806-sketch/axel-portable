...
describe("opencode adapter event mapping", () => {
  ...
  test("extractSessionID handles OpenCode session event metadata", () => {
    expect(
      __testUtils.extractSessionID({
  ...
  test("resolveWorkingDirectory prefers the real directory over a virtual root worktree", () => {
    expect(
      __testUtils.resolveWorkingDirectory({
        worktree: "/",
        directory: "C:\\Users\\adam\\workspace\\codemem",
      }),
    ).toBe("C:\\Users\\adam\\workspace\\codemem");
  });
  ...
  test("resolveProjectName uses OpenCode worktree metadata", () => {
    const projectName = __testUtils.resolveProjectName(
      { worktree: "C:\\Users\\adam\\workspace\\codemem" },
      "/",
    );
